      ...
      <>
        <style>{`
          @media print {
            ...
            body.printing-certificate #certificate * { visibility: visible; }
            #certificate {
              position: fixed;
              top: 0; left: 0;
              width: 100%;
        ...
        <div className="flex flex-col items-center gap-6 w-full">
          ...
          >
            <p className="text-sm text-zinc-400">بسم الله الرحمن الرحيم</p>

            <h2 className="text-2xl font-semibold">Certificate of Faith</h2>
  ...
  return (
    <div className="flex flex-col items-center gap-4 text-center">
      ...
      <input
        ...
        onKeyDown={(e) => e.key === "Enter" && name.trim() && setShowCert(true)}
